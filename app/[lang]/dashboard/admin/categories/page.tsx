...
export default async function DashboardAdmin({
  ...
  return (<>
    <DashboardNav activeLink="adminCategories" iconUrl={iconUrl} dictionary={dictionary.nav} backendUrl={String(process.env.backendUrl)} userData={userData} />
    <DashboardContent>
    <div className="min-h-[100vh] px-16 py-8 max-w-screen-xl m-auto"> 
            <AdminSettingsCategories userData={userData} dictionary={dictionary["admin-dashboard"]} backendUrl={String(process.env.backendUrl)} />
        </div>
    </DashboardContent>
