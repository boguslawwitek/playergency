...
export default async function DashboardAdmin({
  ...
  return (<>
    <DashboardNav activeLink="adminRoles" iconUrl={iconUrl} dictionary={dictionary.nav} backendUrl={String(process.env.backendUrl)} />
    <DashboardContent>
    <div className="min-h-[100vh] px-16 py-8 max-w-screen-xl m-auto"> 
            <AdminSettingsRoles lang={lang} dictionary={dictionary["admin-dashboard"]} backendUrl={String(process.env.backendUrl)} />
        </div>
    </DashboardContent>
